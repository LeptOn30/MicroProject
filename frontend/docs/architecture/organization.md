# Angular Project Organization - mproject-angular

This document explains the folder organization and architectural patterns used in the mproject-angular project. This application follows a **feature-based modular architecture** with clear separation between business features and shared utilities.
...
The mproject-angular application is organized using a **feature-based architecture** where:
...
The mproject-angular project uses a **modern, scalable architecture**:
